...
def main():
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        print('epoch {:2d} | time used: {:5.2f}s | train_loss {:4.3f} | '
              'valid loss {:4.3f} | valid acc {:4.3f} | mae {:4.3f} | mse {:4.3f} | rmse {:4.2f} | r2 {:4.2f} | sharp {:4.2f}'.format(
            epoch, (time.time() - epoch_start_time), train_loss, val_loss, val_acc, result['mae'], result['mse'], result['rmse'], result['r2'], result['sharp_value']) )
        args.wb.log({
