...
true_label = list()
threshold, threshold2 = 0.0006, 0.0005
window_size = 10
total_len = 10000
data = word[:total_len]
...
otherdat = model_pred2(true_label)
...
print("#" * 100)
print("Sharp Accuracy: {:5.4f}".format(len(acc_list)/total_len))
print("mean_s: {:5.4f} std_s: {:5.4f} "
      "result_s: {:5.4f}".format(avg_s, std_s, sharp_value))

workbook.save("result/result_sharp.csv")
