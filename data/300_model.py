...
for i in range(1, len(true_label)):
    ...
    s = float(data[i + 1] - data[i]) / float(data[index]) * true_label[index]
...
# workbook.save("step_2021_300_"+str(window_size)+"_result.xls")
# plt.plot(s_value)
