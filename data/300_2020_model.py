...
worksheet.write(0, 4, "Pred_label")
worksheet.write(0, 5, "Position")
worksheet.write(0, 6, "Pred_Position")
worksheet.write(0, 7, "Position_0")
worksheet.write(0, 8, "Position_1")
worksheet.write(0, 9, "Position_2")
...
for i in range(1, len(true_label)):
    ...
    worksheet.write(i, 4, otherdat[i])
    worksheet.write(i, 5, float(true_label[i])/2)
    worksheet.write(i, 6, float(otherdat[i])/2)
    # worksheet.write(i, 7, float(data[i+1]-data[i])*0.0002)
...
workbook.save("result_new/2020_300_"+str(window_size)+"_result.xls")
