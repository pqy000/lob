...
num = 2
x = [1,2,3,4,5]#点的横坐标
k1   = [2.163,1.728,1.18,0.93,0.73]
k3 =  [2.243,2.028,1.34, 1.01,0.78]
...
plt.plot(x,k1,'s-',color = 'orange',label="month-1")
plt.plot(x,k3,'h-',color = 'blue', lw=2, label="month-6")
