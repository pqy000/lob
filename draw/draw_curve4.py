...
# plt.subplot(111)
num = 2
x = [2,3,4,5,6,7,8,9,10]#点的横坐标
# k1   = [18.1,22.33,24.28,42.32,48.31,51.3,49.4,48.3,47.32,46.22]
# k1 = [0.92084,1.6482,1.8446,1.928,2.0631,2.1321,2.1732,2.15,2.01,2.03]
# k1 = [16.42,20.33,24.58,30.32,39.31,36.21,38.32,37.3,37.6]
k1 = [0.8284,1.482,1.7646,1.83,2.0126,1.9921,1.932,1.95,1.94]
