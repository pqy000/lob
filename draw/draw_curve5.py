...
k1   =  [22.33,24.28,42.32,48.31,51.3,49.4,48.3,47.32,46.22]
k3   = [16.42,20.33,24.58,30.32,39.31,36.21,38.32,37.3,37.6]
...
plt.plot(x,k1,'s-',color = 'blue',label="1-month")
plt.plot(x,k3,'h-',color = 'red', lw=2, label="2-month")
